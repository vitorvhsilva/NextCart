...
awslocal sns create-topic --name cart-writer-cqrs-topic --region us-east-1

awslocal sqs create-queue --queue-name cart-writer-cqrs-queue --region us-east-1

awslocal sns subscribe \
  --topic-arn "arn:aws:sns:us-east-1:000000000000:cart-writer-cqrs-topic" \
  --protocol sqs \
  --notification-endpoint "arn:aws:sqs:us-east-1:000000000000:cart-writer-cqrs-queue" \
  --region us-east-1
